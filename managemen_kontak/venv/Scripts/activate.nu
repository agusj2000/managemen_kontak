...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Python311\Project_Udemy\managemen_kontak\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Python311\Project_Udemy\managemen_kontak\venv\Scripts\deactivate.nu'
